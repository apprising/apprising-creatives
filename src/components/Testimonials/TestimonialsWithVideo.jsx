              ...
              <div className="testim-box">
                ...
                >
                  <SwiperSlide className="item">
                    <p>
                      I love how the team was very accomodating, they helped me
                      create my vision to reality
                    </p>
                    <div className="info">
                      <div className="img">
                        <div className="img-box">
                          <img src="/img/clients/Jeff-Ricks.jpg" alt="" />
                        </div>
                      </div>
                      <div className="cont">
                        <div className="author">
                          <h6 className="author-name">Jeff Ricks</h6>
